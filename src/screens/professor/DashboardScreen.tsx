...
export default function DashboardScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.botaoPrimario} onPress={() => navigation.navigate('VincularProfessor')}>
        <Text style={styles.textoBotaoPrimario}>Vincular-se a uma academia</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.botaoPrimario} onPress={() => navigation.navigate('SolicitacoesProfessor')}>
